          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                padding: EdgeInsets.only(bottom: 80), // Add padding to avoid overlap with input
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ForumPostBody(
                        ...
                        imageUrls: imageUrls,
                        likes: item.likeCount.toString() ?? "0",
                        comments: item.commentCount.toString() ?? "0",
                        onLikeToggle: () {
                    ...
                    ...item.comments!.reversed.map((comment) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
