...
class _AdvertisementListState extends State<AdvertisementList> {
  ...
  // ✅ Dummy list of ad image URLs
  final List<String> dummyAds = [
    'https://kbaiota.org/assets/uploads/gallery/c7272-dsc02118-2.jpg',
    'https://kbaiota.org/assets/uploads/files/ebcef-img-20240229-wa0029.webp',
  ];
  ...
  void startAutoSlide() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 5), (_) {
      if (dummyAds.length > 1 && _pageController.hasClients) {
        final nextPage = (currentAdIndex + 1) % dummyAds.length;
        setState(() => currentAdIndex = nextPage);
            ...
            SizedBox(
              ...
              child: ScrollConfiguration(
                ...
                child: PageView.builder(
                  key: const PageStorageKey('advertisement_page_view'),
                  ...
                  itemBuilder: (context, index) {
                    final imageUrl = dummyAds[index];
                    return AdvertisementCard(imageUrl: imageUrl);
                  },
                ),
              ),
            ),
            if (dummyAds.length > 1)
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: List.generate(dummyAds.length, (index) {
                  final isActive = index == currentAdIndex;
